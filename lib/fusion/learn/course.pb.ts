...
export const Course = {
  /**
   * Serializes Course to protobuf.
   */
  encode: function (msg: PartialDeep<Course>): Uint8Array {
    return Course._writeMessage(
      msg,
  ...
  /**
   * Deserializes Course from protobuf.
   */
  decode: function (bytes: ByteSource): Course {
    return Course._readMessage(
      Course.initialize(),
  ...
  /**
   * Initializes Course with all fields set to their default value.
   */
  initialize: function (msg?: Partial<Course>): Course {
    return {
      name: "",
      uid: "",
      displayName: "",
...
export const CourseJSON = {
  /**
   * Serializes Course to JSON.
   */
  encode: function (msg: PartialDeep<Course>): string {
    return JSON.stringify(CourseJSON._writeMessage(msg));
  },

  /**
   * Deserializes Course from JSON.
   */
  decode: function (json: string): Course {
    return CourseJSON._readMessage(CourseJSON.initialize(), JSON.parse(json));
  },
   ...
   * @private
   */
  _writeMessage: function (msg: PartialDeep<Course>): Record<string, unknown> {
   ...
   * @private
   */
  _readMessage: function (msg: Course, json: any): Course {
