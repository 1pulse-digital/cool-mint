...
const BlogWidget: React.FC<BlogWidgetProps> = ({
    ...
    <div className="grid py-10 sm:py-0 h-96 relative mx-4 mb-8">
      ...
      <div className="grid z-10 absolute h-auto bottom-0 px-5 bg-background opacity-65 w-full">
        <div className="flex row space-x-4 py-2">
          <span className="text-secondary text-xs py-1 inline-flex items-start">
            {/* Your date icon */}
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
        ...
        <Link href={linkUrl}>
          <span className="text-secondary font-helvetica text-[18px] text-start font-bold leading-tight hover:text-primary pb-1">
            {title}
          </span>
        </Link>
