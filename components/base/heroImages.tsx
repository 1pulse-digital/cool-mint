...
export const HeroImages = () => {
  return (
    ...
    <div className="flex flex-wrap justify-center items-stretch md:justify-between lg:space-x-2 w-full">
      ...
      <div className="flex-1 flex sm:flex-col sm:justify-center p-5 font-helvetica">
        ...
        <span className="text-center font-helvetica sm:text-start md:text-start text-BodyText font-normal text-textColor lg:text-start">
