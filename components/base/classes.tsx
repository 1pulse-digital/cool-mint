  ...
  return (
    <div className="lg:mx-28">
      ...
      />
              ...
              <span className="text-xl pt-8 font-helvetica font-bold text-primary">
                R1,500.00
              </span>
              <p
                className={
      ...
      <Tabs defaultValue="class1">
        <div className="grid justify-center items-center sm:mx-32">
          <Carousel className="mx-10 pt-10 2xl:mx-80 xl:mx-72 lg:mx-32 md:mx-28">
            <CarouselContent>
              <CarouselItem>
       ...
       {/*  <TabsContent className="bg-background font-helvetica grid justify-center" value="class1">
          <Card className="border-0 bg-background">
            ...
            <h1
              ...
              <p
                className={
                  "pt-8 text-center font-helvetica text-BodyText text-sm font-normal text-secondary"
                }
              >
                Dummy text is text that is used in the publishing industry or by
                web designers to occupy the space which will later be filled
