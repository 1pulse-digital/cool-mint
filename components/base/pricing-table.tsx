...
function PricingTab(props: PricingTabProps) {
  ...
  return (
    <div
      className={`h-full ${isPopular ? "dark" : ""} ${isPopular ? "border-4 border-primary" : "border border-primary border-opacity-60"} rounded-2xl bg-background ${isPopular ? "border-bold" : "border-primary"} md:h-[680px] lg:h-[780px] xl:h-[640px] 2xl:h-[600px]`}
    >
...
export default function PricingTable() {
  return (
    <div className="mx-8 sm:mx-20 md:mx-12 lg:mx-8 xl:mx-16 2xl:mx-40">
      {/* Pricing toggle */}
