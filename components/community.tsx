...
export const Community = () => {
  return (
    <div className="flex py-20 flex-col items-center justify-center p-5 sm:p-0 sm:py-8 md:p-5 font-helvetica">
      <h1 className="py-4 text-center text-headings font-bold leading-tight text-foreground">
        Makerspace Community<span className="text-primary">.</span>
      </h1>
      <span className="text-center  text-BodyText font-normal text-muted-foreground lg:px-40 xl:px-40 2xl:px-52">
