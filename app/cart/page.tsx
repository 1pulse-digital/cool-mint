  ...
  return (
    <div className={"bg-background py-20"}>
      ...
      <div className="text-xs text-secondary font-helvetica font-normal inline-flex justify-center items-center">
          ...
          <div className="pb-2 2xl:w-80 px:w-40 ">
...
<div className="sm:flex items-start space-x-20 2xl:mx-10 md:mx-0 lg:px-52 pt-8">
<div className="lg:w-72"> 
<Link href="/login">  
<Button color="primary" className="w-full mt-4">Proceed to Checkout</Button></Link></div>
