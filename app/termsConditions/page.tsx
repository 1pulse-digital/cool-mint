    ...
    <div className="bg-background py-20">
      <div className="px-8 font-helvetica sm:px-10 md:px-10 lg:px-10 xl:px-12 2xl:px-28">
        ...
        <p className="text-base font-normal text-foreground ">
          ...
          practices for this website. We recognize the importance of protecting
          your privacy and our policy is designed to assist you in understanding
          how we collect, use and safeguard the personal information you provide
          to us and to assist you in making informed decisions when using our
          site. This policy will be continuously assessed against new
          ...
          <br />
          <br />
          Personal Information You Choose to Provide Email Information
          <br />
          <br />
          ...
          <br />
          <br />
          Website Use Information Similar to other commercial websites, our
          website utilizes a standard technology called “cookies” (see
          explanation below, “What Are Cookies?”) and web server log files to
          collect information about how our website is used. Information
          ...
          site and better tailor it to meet your needs.
          <br />
          <br />
          ...
          your hard drive or pass on computer viruses.
          <br />
          <br />
          ...
          transactions or provide services that you have requested.
          <br />
          <br />
          ...
          particular messages as soon as technically feasible.
          <br />
          <br />
          Surveys & Contests
          <br />
          ...
          assets, and may be part of those assets that are transferred.
          <br />
          <br />
