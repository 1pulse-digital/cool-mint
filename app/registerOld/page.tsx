      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="grid place-content-center px-8 md:px-16 2xl:mx-52 2xl:px-0">
          <div className={"grid content-center font-helvetica  md:max-w-prose"}>
            <h1
              className={
                "py-2 text-center font-helvetica text-headings font-bold text-foreground sm:text-start md:py-0 md:text-start lg:py-0"
              }
            >
              Create an account
            </h1>
          ...
          <div className="inline-flex flex-row space-x-4">
            <div className="pt-4">
              <p
                className={
                  "text-center font-helvetica text-[14px] text-muted-foreground"
                }
              >
          ...
          <div className="py-4">
            ...
            <div className="flex items-center justify-center space-x-4 py-10">
              ...
              <p className="font-helvetica text-xs text-muted-foreground">
                OR CONTINUE WITH
              </p>
              <hr className="mx-2 h-[1px] flex-grow border-0 bg-secondary"></hr>
            </div>
            ...
            <p className="py-10 text-center font-helvetica text-xs text-muted-foreground">
