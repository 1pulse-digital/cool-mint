...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="font-helvetica sm:px-10 lg:px-10 md:px-10 xl:px-12 2xl:px-28 px-8">
    <div className="inline-flex justify-start items-start  font-helvetica text-xs font-normal text-secondary pb-2">
            <Link href="/">
              <div>
                Home
...
Who we are
<br/><br/>
Our website address is: https://madeinworkshop.co.za/
<br/><br/>
...
<br/><br/>
We also may use DART cookies for ad serving through Google’s DoubleClick, which places a cookie on your computer when you are browsing the web and visits a site using DoubleClick advertising (including some Google AdSense advertisements). This cookie is used to serve ads specific to you and your interests (”interest based targeting”). The ads served will be targeted based on your previous browsing history (For example, if you have been viewing sites about visiting Las Vegas, you may see Las Vegas hotel advertisements when viewing a non-related site, such as on a site about hockey). DART uses “non personally identifiable information”. It does NOT track personal information about you, such as your name, email address, physical address, telephone number, social security numbers, bank account numbers or credit card numbers. You can opt-out of this ad serving on all sites using this advertising by visiting http://www.doubleclick.com
<br/><br/>
